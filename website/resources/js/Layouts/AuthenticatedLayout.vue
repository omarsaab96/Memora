...
<template>
    <div>
        <div class="min-h-screen bg-gray-100">
                                ...
                                <Dropdown align="right" width="48">
                                    <template #trigger>
                                        <span class="inline-flex rounded-md">
                                            <button type="button"
                                                class="inline-flex items-center rounded-md border border-transparent bg-[#00D6CA] px-3 py-2 text-sm font-medium leading-4 text-white transition duration-150 ease-in-out hover:text-gray-600 focus:outline-none">
            ...
            <!-- Page Heading -->
            <header class="bg-white-100 border-b border-b-gray-300" v-if="$slots.header">
